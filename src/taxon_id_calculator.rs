...
//         tree.arena[0].children.insert(0, 1);
//         tree.arena[0].children.insert(3, 2);
//         tree.arena[0].children.insert(5, 3);
//         tree.arena[1].children.insert(1, 4);
//         tree.arena[1].children.insert(5, 5);
//
